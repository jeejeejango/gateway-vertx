...
public class GatewayVerticle extends AbstractVerticle {
    ...
    public void start() {
        ...
        router.post("/api/cart/remove/:cartId/:itemId/:quantity").handler(this::deleteFromCart);
        ...
        ServiceDiscovery.create(vertx, discovery -> {
            ...
            // Zip all 3 requests
            Single.zip(catalogDiscoveryRequest, inventoryDiscoveryRequest, cartDiscoveryRequest, (c, i, ca) -> {
